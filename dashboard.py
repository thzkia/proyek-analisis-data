...
# Membuat judul
st.header('Bike Sharing System  :bike::sparkles:')
...
# Membuat jumlah penyewaan berdasarkan weekday dan workingday
st.subheader('Weekday and Workingday Rentals')

fig, axes = plt.subplots(nrows=2, ncols=1, figsize=(15,10))

colors1=["tab:purple", "tab:pink"]
colors2=["tab:blue", "tab:brown", "tab:green", "tab:red", "tab:purple", "tab:grey", "tab:pink"]
